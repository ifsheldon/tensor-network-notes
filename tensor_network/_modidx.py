...
d = { 'settings': { 'doc_baseurl': '/tensor-network',
  ...
  'syms': { 'tensor_network.algorithms.gmps': { 'tensor_network.algorithms.gmps.calc_gradient': ( '4-5.html#calc_gradient',
                                                ...
                                                'tensor_network.algorithms.gmps.train_gmps': ( '4-5.html#train_gmps',
                                                                                               'tensor_network/algorithms/gmps.py')},
            'tensor_network.algorithms.quantum_kernel_visualization': { 'tensor_network.algorithms.quantum_kernel_visualization.metric_matrix_neg_log_cos_sin': ( '4-8.html#metric_matrix_neg_log_cos_sin',
                                                                                                                                                                  'tensor_network/algorithms/quantum_kernel_visualization.py'),
                                                                        'tensor_network.algorithms.quantum_kernel_visualization.visualize_tsne': ( '4-8.html#visualize_tsne',
                                                                                                                                                   'tensor_network/algorithms/quantum_kernel_visualization.py')},
            ...
            'tensor_network.mps.modules': { 'tensor_network.mps.modules.MPS': ('4-2.html#mps', 'tensor_network/mps/modules.py'),
                                            ...
                                            'tensor_network.mps.modules.MPS.virtual_dim': ( '4-2.html#mps.virtual_dim',
                                                                                            'tensor_network/mps/modules.py'),
                                            'tensor_network.mps.modules._project_multi_qubits': ( '4-6.html#_project_multi_qubits',
                                                                                                  'tensor_network/mps/modules.py'),
                                            'tensor_network.mps.modules._project_one_qubit': ( '4-6.html#_project_one_qubit',
                                                                                               'tensor_network/mps/modules.py')},
