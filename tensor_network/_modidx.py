...
d = { 'settings': { 'doc_baseurl': '/tensor-network',
  ...
  'syms': { 'tensor_network.algorithms.dyn_feature_selection_OEE': { 'tensor_network.algorithms.dyn_feature_selection_OEE.OEE_variation_one_qubit_measurement': ( '4-10.html#oee_variation_one_qubit_measurement',
            ...
            'tensor_network.mps.modules': { 'tensor_network.mps.modules.MPS': ('4-2.html#mps', 'tensor_network/mps/modules.py'),
                                            ...
                                            'tensor_network.mps.modules.MPS.entanglement_entropy_onsite': ( '4-9.html#mps.entanglement_entropy_onsite',
                                                                                                            'tensor_network/mps/modules.py'),
