...
d = { 'settings': { 'doc_baseurl': '/tensor-network',
  ...
  'syms': { 'tensor_network.algorithms.dyn_feature_selection_OEE': { 'tensor_network.algorithms.dyn_feature_selection_OEE.dyn_OEE_analyze': ( '4-10.html#dyn_oee_analyze',
